...
@endsection
@section( 'content' )
<x-dashboard.modal-window name="product" :id="$item->id"/>
<form action="{{route('dashboard.admin.products.update', $item->id)}}" class="product-table mx-auto text-left">
    ...
    <div class="d-flex row m-4">
        <div class="d-flex flex-column cropper-img-product mr-4">
            <div class="product-img-cropper mx-auto">
                <img
                    ...
                    src="{{ asset( "images/products/{$item->id}/full.png" ) }}"
                    height="1024"
                    width="1024"
                />
            </div>
        ...
        <div class="col-sm col-md-5 col-lg-3 d-flex p-0 mt-4 mt-sm-0 flex-column">
            <div class="form-group mb-4">
                ...
                <input type="text" class="form-control shadow-sm" name="title" value="{{ $item->title }}" validate="text" text-min-len="2" text-max-len="32">
            </div>
            <div class="form-group mb-2">
                <select name="partner_id" class="custom-form-control" validate="select">
                    <option value="" hidden>Производитель</option>
                    @foreach( $partners as $partner )
                        <option {{ $partner->id != $item->partner_id ?: 'selected' }} value="{{ $partner->id }}">{{ $partner->company_name }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group mb-2">
                <select name="product_type_id" class="custom-form-control" validate="select">
                    ...
                    @foreach( $product_types as $type )
                        <option {{ $type->id != $item->product_type_id ?: 'selected' }} value="{{ $type->id }}">
            ...
            <div class="form-group mb-2">
                <select name="product_pack_id" class="custom-form-control" validate="select">
                    ...
                    @foreach( $product_packs as $pack )
                        <option {{ $pack->id != $item->product_pack_id ?: 'selected' }} value="{{ $pack->id }}">
            ...
            <div class="form-group mb-4">
                <select name="product_status_id" class="custom-form-control" validate="select">
                    ...
                    @foreach( $product_statuses as $status )
                        <option {{ $status->id != $item->product_status_id ?: 'selected' }} value="{{ $status->id }}">
            ...
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col px-0">
                    <input class="form-control simple-number-input" name="new_cost" type="number" value="{{ $item->new_cost }}" step="1" min="1" max="999"/>
        ...
        <div class="col-md-12 col-lg ml-lg-4 mt-2 mt-sm-4 mt-lg-0 px-0 col-no-padding text-main-dark">
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col">
                    <input class="form-control simple-number-input" name="cost" type="number" value="{{ $item->cost }}" step="1" min="1" max="999"/>
                    <span class="ml-2">₽</span>
                </div>
            </div>
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col">
                    <input class="form-control simple-number-input" name="group" type="number" value="{{ $item->group }}" step="1" min="1" max="999"/>
            ...
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col">
                    <input class="form-control simple-number-input" name="fat" type="number" value="{{ $item->fat }}" step="1" min="1" max="999"/>
                    <span class="ml-2">%</span>
                </div>
            </div>
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col">
                    <input class="form-control simple-number-input" name="weight" type="number" value="{{ $item->weight }}" step="1" min="1" max="9999"/>
            ...
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col">
                    <input class="form-control simple-number-input" name="temperature" type="number" value="{{ $item->temperature }}" step="1" min="1" max="999"/>
            ...
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col">
                    <input class="form-control simple-number-input" name="life_time" type="number" value="{{ $item->life_time }}" step="1" min="1" max="999"/>
            ...
            <div class="product-info-inputs">
                ...
                <div class="product-info-inputs col">
                    <input class="form-control simple-number-input" name="limit" type="number" value="{{ $item->limit }}" step="1" min="1" max="999"/>
                    <span class="ml-2">шт.</span>
                </div>
            </div>
        </div>
