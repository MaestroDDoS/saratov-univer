...
<div class="aside-achievements">
	<div class="unit-spacing-sm flex-column">
		<div><img src="{{ asset('images/media/best-employer-1.png') }}" alt="" width="163" height="163"/></div>
	</div>
	<div class="unit-spacing-sm flex-column">
		<div><img src="{{ asset('images/media/best-employer-2.png') }}" alt="" width="163" height="163"/></div>
	</div>
	<div class="unit-spacing-sm flex-column">
		<div><img src="{{ asset('images/media/best-employer-3.png') }}" alt="" width="163" height="163"/></div>
	</div>
</div>
...
<dd>Ждём Ваших резюме по е-mail: <a href="mailto:{{ config('saratov.mail_main') }}">{{ config('saratov.mail_main') }}</a></dd>
<dd>И готовы ответить на все интересующие вопросы по телефону:
	<a href="tel:8 ({{ config('saratov.contacts_phones.prefix') }}) {{ config('saratov.contacts_phones.list.work') }}">
		8 ({{ config('saratov.contacts_phones.prefix') }}) {{ config('saratov.contacts_phones.list.work') }}
	</a>
</dd>
@endsection
