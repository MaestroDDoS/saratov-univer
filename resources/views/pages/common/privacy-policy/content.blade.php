...
<section class="breadcrumbs-custom">
	<div class="parallax-container" data-parallax-img="{{ asset('images/bg-offer.jpg') }}">
		<div class="breadcrumbs-custom-body parallax-content context-dark">
			<div class="container">
				<h2 class="breadcrumbs-custom-title">{{ __('navigation.common.privacy-policy') }}</h2>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 col-xl-8">
				...
				</dl><a class="privacy-link" href="mailto:{{ config('saratov.mail_main') }}">{{ config('saratov.mail_main') }}</a>
			</div>
		</div>
	</div>
</section>
