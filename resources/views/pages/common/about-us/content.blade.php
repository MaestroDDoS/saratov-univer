...
@section('content')
	<section class="breadcrumbs-custom">
		<div class="parallax-container" data-parallax-img="{{ asset('images/backgrounds/bg-about_us.jpg') }}">
			<div class="breadcrumbs-custom-body parallax-content context-dark">
				<div class="container">
					<h2 class="breadcrumbs-custom-title">{{ __('common.our_company') }}</h2>
		...
		<div class="container">
			<div class="row row-40 row-md-60 justify-content-center align-items-xl-center">
				<div class="col-md-11 col-lg-6 col-xl-5">
					...
					</div><a class="button button-lg button-shadow-2 button-primary button-zakaria" href="{{ route('common.info','about-products') }}">{{ __( 'common.details' ) }}</a>
				</div>
				<div class="col-md-11 col-lg-6 col-xl-7">
					<div class="slick-slider-1 inset-xl-left-35">
						<div class="slick-slider carousel-parent slick-nav-1 slick-nav-2" id="carousel-parent" data-items="1" data-autoplay="true" data-slide-effect="true" data-child="#child-carousel" data-for="#child-carousel" data-arrows="true">
							<div class="item"><img src="{{ asset('images/media/about-1-634x373.jpg') }}" alt="" width="634" height="373"/></div>
							<div class="item"><img src="{{ asset('images/media/about-2-634x373.jpg') }}" alt="" width="634" height="373"/></div>
							<div class="item"><img src="{{ asset('images/media/about-3-634x373.jpg') }}" alt="" width="634" height="373"/></div>
							<div class="item"><img src="{{ asset('images/media/about-4-634x373.jpg') }}" alt="" width="634" height="373"/></div>
						</div>
						<div class="slick-slider child-carousel" id="child-carousel" data-items="3" data-sm-items="4" data-md-items="4" data-lg-items="4" data-xl-items="4" data-xxl-items="4" data-for="#carousel-parent">
							<div class="item"><img src="{{ asset('images/media/about-1-143x114.jpg') }}" alt="" width="143" height="114"/></div>
							<div class="item"><img src="{{ asset('images/media/about-2-143x114.jpg') }}" alt="" width="143" height="114"/></div>
							<div class="item"><img src="{{ asset('images/media/about-3-143x114.jpg') }}" alt="" width="143" height="114"/></div>
							<div class="item"><img src="{{ asset('images/media/about-4-143x114.jpg') }}" alt="" width="143" height="114"/></div>
						</div>
					</div>
				</div>
			</div>
	...
	<x-common.about-us.counter/>
	<x-common.about-us.our-team/>
@endsection
