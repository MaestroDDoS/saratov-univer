		...
		<div class="rd-navbar-main">
			<div class="rd-navbar-panel">
				...
				<div class="rd-navbar-brand">
					<a class="brand" href="<?php echo e(route('common')); ?>"><img class="brand-logo-dark" src="<?php echo e(asset('images/media/saratovs_milk.svg')); ?>"/></a>
				</div>
			</div>
...
<?php /**PATH C:\OpenServer\domains\saratov\resources\views/layouts/common/navbar-default.blade.php ENDPATH**/ ?>