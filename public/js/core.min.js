...
/**
 * @module       Device.js
 * @see          https://gist.github.com/lyquix-owner/34a3ed98b990c3c61151d30de2f42702
 * @license      MIT
 */
$(function(){$("html").addClass(function(){var e,r,i,o=navigator.userAgent;function t(e){var r=o.match(e);return r&&r.length>1&&r[1]||""}return/opera|opr/i.test(o)?e={name:"Opera",type:"opera",version:t(/version\/(\d+(\.\d+)?)/i)||t(/(?:opera|opr)[\s\/](\d+(\.\d+)?)/i)}:/msie|trident/i.test(o)?e={name:"Internet Explorer",type:"msie",version:t(/(?:msie |rv:)(\d+(\.\d+)?)/i)}:/chrome.+? edge/i.test(o)?e={name:"Microsft Edge",type:"msedge",version:t(/edge\/(\d+(\.\d+)?)/i)}:/chrome|crios|crmo/i.test(o)?e={name:"Google Chrome",type:"chrome",version:t(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)}:/firefox/i.test(o)?e={name:"Firefox",type:"firefox",version:t(/(?:firefox)[ \/](\d+(\.\d+)?)/i)}:!/like android/i.test(o)&&/android/i.test(o)?e={name:"Android",type:"android",version:t(/version\/(\d+(\.\d+)?)/i)}:/safari/i.test(o)?e={name:"Safari",type:"safari",version:t(/version\/(\d+(\.\d+)?)/i)}:(e={name:t(/^(.*)\/(.*) /),version:(r=/^(.*)\/(.*) /,i=o.match(r),i&&i.length>1&&i[2]||"")}).type=e.name.toLowerCase().replace(/\s/g,""),e}().type)});
