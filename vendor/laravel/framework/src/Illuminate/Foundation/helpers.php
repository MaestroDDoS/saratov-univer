...
if (! function_exists('trans_fb')) {
     ...
     */
    function trans_fb($id, $fallback, $replace = [], $locale = null)
    {
        return ($id === ($translation = trans($id, $replace, $locale))) ? trans($fallback, $replace, $locale) : $translation;
    }
}

if (! function_exists('__nav')) {
    function __nav($route_name = null, $page = null)
    {
        return  __( "navigation." . Utilities::getRoutePage( $route_name ?? Route::currentRouteName() , $page ) );
    }
}
